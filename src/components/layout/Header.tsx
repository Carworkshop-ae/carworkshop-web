...
export function Header({ settings }: HeaderProps) {
  ...
  const mobileDrawer = (mobileOpen && mounted) ? createPortal(
    <div className="md:hidden fixed inset-0 z-[9999]">
      <div className="fixed inset-0 bg-black/40 backdrop-blur-sm" onClick={() => setMobileOpen(false)} aria-hidden="true" />
      <div className="fixed right-0 top-0 bottom-0 h-full w-[85%] max-w-sm bg-white shadow-elevated flex flex-col z-[10000]" role="dialog" aria-modal="true" aria-label="Navigation menu">
